...
export const LeftSection = () => {
  return (
    <section className="h-screen w-1/2 bg-red-300 px-16 py-32">
      <div className="flex h-full flex-col justify-between">
        <div>
          <h4 className="text-2xl font-normal tracking-widest">I&apos;m</h4>
          <h1 className="font-[montserrat] text-8xl font-extrabold">JISS</h1>
          <h1 className="font-[montserrat] text-8xl font-extrabold">JØY</h1>
